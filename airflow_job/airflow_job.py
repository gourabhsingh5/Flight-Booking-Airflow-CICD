...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow_sparkjobs")
    bq_project = Variable.get("bq_project", default_var="psychic-medley-446820-m5")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"flight-booking-ci-cd/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/flight-booking-ci-cd/spark-job/spark_transformation_job.py",  # Main Python file
